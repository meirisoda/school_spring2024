...
- **documentation errors.** 
	- As EHRs typically have a number of standardized data that you must input, which lowers the likelihood of the nurse overlooking things or forgetting to conduct an assesment. 
EHRs reduce the likelihood of these errors by eliminating these factors.  

This ensures that every patient 
